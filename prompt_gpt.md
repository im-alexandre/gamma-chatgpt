...
- Cada card DEVE conter:
  1. Título
  2. Texto corrido **bem curto!!!* curto (no máximo duas frases)
- Tentar criar tópicos
- Não precisa ser perfeito. Clareza > elegância.
...
- Se houver **imagem conceitual** (diagramas, telas, fluxos):
  ...
  - Insira no card correspondente, exatamente:

> **[NOTA PARA REVISÃO] Há imagem conceitual associada a este conteúdo (tente descrever).**
